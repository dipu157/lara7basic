...
@section('content')
                            ...
                            <div class="card text-primary bg-gray">
                                <div class="card-body">
                                    <div class="form-group row" id="md-name">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('basiccrud_id', $BasicCrud, null, ['id' => 'basiccrud_id', 'class' => 'form-control d-block']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row" id="md-name">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="gender1" name="gender" type="radio"
                                                    value="M">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="gender2" name="gender" type="radio"
                                                    value="F">
                                    ...
                                    <div class="form-group row" id="md-name">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="speciality1" name="speciality[]"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="speciality2" name="speciality[]"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="speciality3" name="speciality[]"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="speciality4" name="speciality[]"
                                                    type="checkbox" value="Oracle">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="speciality5" name="speciality"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" id="dob" name="dob" readonly="" type="text"
    ...
    <!-- Modal For Edit  -->
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="editOtherCrudModal" role="dialog"
        tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <!--Header-->
                            ...
                            <div class="card text-primary bg-gray">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" id="md-name">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('basiccrud_idU', $BasicCrud, null, ['id' => 'basiccrud_idU', 'class' => 'form-control d-block']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row" id="md-name">
                                        <label class="col-sm-4 col-form-label text-md-right" for="gender">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" id="dob_idU" name="dob" readonly="" type="text"
                                                value="" />
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Modal For Add Image -->
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="photoModal" role="dialog"
        tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
...
@section('script')
    <script type="text/javascript">
                    ...
                    if (response.status == 200) {
                        ...
                        $.each(dataJSON, function(i, item) {
                            ...
                            $('<tr>').html(
                                ...
                                "<td><img class='table-img' alt='photo' src=" + dataJSON[i].photo +
                                "></td>" +
                                "<td>" + status + "</td>" +
                                "<td><a class='PhotoBtn btn btn-info btn-sm' data-id=" + dataJSON[i].id +
                                ">Upload</a></td>" +
                                "<td><a class='EditBtn' data-id=" + dataJSON[i].id +
                                "><i class='fas fa-edit'></i></a> &nbsp; &nbsp;" +
                                "<a class='DeleteBtn' data-id=" + dataJSON[i].id +
        ...
        //Confirm Edit
        $('#UpdateBtnClickId').click(function() {

            var id = $('#EditId').val();
            var basiccrud_id = $('#basiccrud_idU').val();
            ...
            otherCrudUpdateClick(id, basiccrud_id, gender, dob);
        })

        // Method for Click Update Btn
        function otherCrudUpdateClick(id, basiccrud_id, gender, dob) {

            if (gender.length == 0) {
                alert('Gender Required');
            } else {
                $('#UpdateBtnClickId').html("<div class='spinner-border spinner-border-sm' role='status'></div>")
                axios.post('/otherCrudUpdateBtnClick', {
                        id: id,
                        user: basiccrud_id,
                        gender: gender,
                        dob: dob,
                    ...
                    .then(function(response) {
                        $('#UpdateBtnClickId').html("Update");
                        if (response.data == 1) {
                            $('#editOtherCrudModal').modal('hide');
